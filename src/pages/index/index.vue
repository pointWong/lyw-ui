<template>
  ...
  <view
    :style="`padding-top:calc(${statusHeight}px + 44px);padding-bottom:170px`"
  >
    <uni-collapse>
      ...
      <uni-collapse-item title="日期范围选择器">
        <lyw-card>
          <lyw-date-range></lyw-date-range>
        </lyw-card>
      </uni-collapse-item>
      ...
      <uni-collapse-item title="配送时间">
        <lyw-card>
          <lyw-btn
            @click="$refs['lyw-delivery-time'].open()"
            title="显示配送时间"
          ></lyw-btn>
          <lyw-delivery-time
            :type="2"
            :timeOpts="timesList"
            ref="lyw-delivery-time"
          ></lyw-delivery-time>
        </lyw-card>
      </uni-collapse-item>
      ...
      <!-- <uni-collapse-item title="Modal">
        ...
        <lyw-modal v-model="showModal"></lyw-modal>
			...
			<uni-collapse-item title="ModalFilter">
        <lyw-card>
          <lyw-btn @click="showModalFilter = true" title="显示"></lyw-btn>
        </lyw-card>
        <lyw-modal-filter v-model="showModalFilter"></lyw-modal-filter>
      </uni-collapse-item> -->
      <uni-collapse-item title="空状态">
        <lyw-card>
          <div style="height: 300px">
            <lyw-no-data margin-top="0"></lyw-no-data>
          </div>
        </lyw-card>
      </uni-collapse-item>
      <uni-collapse-item title="拨打电话">
        <lyw-card>
          <text
            v-on:click="$refs['phonecall'].show()"
            style="text-decoration: underline; color: cornflowerblue"
            >1370003030</text
          >
      ...
      <uni-collapse-item title="左滑操作">
        <lyw-card>
          <lyw-swipeAction>
            <view style="width: 100%; height: 80px; background-color: aqua"
              >左滑看看</view
            >
          </lyw-swipeAction>
        </lyw-card>
      ...
      <uni-collapse-item title="tabbar">
        <lyw-card>
          <lyw-tabbar :styles="{ position: 'relative' }"></lyw-tabbar>
        </lyw-card>
      </uni-collapse-item>
    </uni-collapse>
