<template>
  ...
  <uni-popup ref="popup" type="bottom" @change="closePop" :safeArea="false">
    <view class="picker-view-wrap">
      ...
      >
        <picker-view-column>
          <view class="picker-view-item" v-for="(item, i) in years" :key="i"
            >{{ item }}年</view
          >
        </picker-view-column>
        <picker-view-column>
          <view class="picker-view-item" v-for="(item, i) in months" :key="i"
            >{{ item }}月</view
          >
        </picker-view-column>
        <picker-view-column>
          <view class="picker-view-item" v-for="(item, i) in days" :key="i"
            >{{ item }}日</view
          >
        </picker-view-column>
      </picker-view>
